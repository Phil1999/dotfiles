...
If you experience any errors while trying to instll kickstart, run `:checkhealth` for more info
...
require('lazy').setup {
  ...
  -- Adding nvim-tree and nvim-web-devicons
    ...
    config = function()
      ...
      local servers = {
        clangd = {
          cmd = {
            'clangd',
            '--fallback-style=Google', -- Use Google style as the fallback
          },
        },
        -- gopls = {},
        pyright = {},
    ...
    config = function()
      require('solarized-osaka').setup {
        ...
        on_highlights = function(highlights, colors)
          highlights.NvimTreeNormal = { fg = 'None', bg = 'None' }
          highlights.NvimTreeNormalNC = { fg = 'None', bg = 'None' }
          highlights.NvimTreeWinSeparator = { fg = 'None', bg = 'None' }
        end,
